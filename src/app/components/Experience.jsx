...
const Experience = () => {
  const experiences = [
    ...
    },
    {
      ...
      endDate: "March 2023",
      description:
        "API Development and Maintenance: Assist in designing, building,and maintaining REST APIs.Database Management: Support in managing and optimizingdatabases, including data storage, retrieval, and organization.",
    },
  ];
  ...
  return (
    <div
      id="experiences"
      className="max-w-4xl mx-auto mt-6 p-6 shadow-md rounded-md bg-[#120926] text-white"
    >
      <h1 className="text-3xl font-semibold text-center my-20 text-white">
        My Professional Experience
      </h1>
      <div className="space-y-8">
        {experiences.map((experience, index) => (
          <div key={index} className="p-4 bg-[#120926] rounded-md">
            <h3 className="text-xl font-bold hover:text-pink-800 transition-duration-250">
            ...
            <p className="mt-2 hover:text-pink-400 transition-duration-250">
